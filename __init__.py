...
_safe_merge("set_value_mc_v2v_v2")
_safe_merge("set_value_mc_i2v")
_safe_merge("set_value_mc_i2v_v2")
_safe_merge("adaptive_resolution")
_safe_merge("wan_frame_window")
_safe_merge("folder_file_scanner")
_safe_merge("audio_file_scanner")
...
_safe_merge("load_image_from_path")
_safe_merge("collect_files")
_safe_merge("simple_loop")
_safe_merge("colab_nodes")
_safe_merge("draw_mask_on_image")
_safe_merge("clear_vram_passthrough")
_safe_merge("image_concatenate_auto")
_safe_merge("video_sync_concat")
